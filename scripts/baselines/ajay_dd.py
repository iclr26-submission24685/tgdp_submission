"""Reimplementation of 'Ajay et al. - Is Conditional Generative Modeling all you need for Decision-Making?'.

This reimplementation is based on the paper by Ajay et al. It is however closer to the CleanDiffuser implementation
...
if __name__ == "__main__":
    ...
    # Load configuration.
    config = load_config(args.env, "config/baselines/ajay_dd", overrides)
