"""Reimplementation of 'Lu et al. - What makes a good diffusion planner for decision making?'.

This reimplementation is based on the paper by Lu et al.
"""
...
def test(cfg: DictConfig):
    ...
    trainer, dataset, renderer = instantiate_config(cfg)
    episodes = trainer.rollout_episodes(100, return_plans=True)
...
if __name__ == "__main__":
    ...
    # Load configuration.
    config = load_config(args.env, "config/baselines/lu_dv", overrides)
