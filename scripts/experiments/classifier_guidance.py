"""Classifier Guidance Experiment Script.

This script is designed to run experiments using classifier guidance for offline reinforcement learning tasks.
...
if __name__ == "__main__":
    ...
    # Load configuration.
    config = load_config(args.env, "config/experiments/classifier_guidance", overrides)
